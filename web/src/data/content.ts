...
export const stackCards: StackCard[] = [
  ...
  { id: 'wheels', group: 'Drive', part: 'Ti cleat wheels (Phase 2)', spec: '1.55 in Ti cleats — Phase 1 runs rubber to learn', role: 'Bite on wood and steel. Foam shreds on contact.', stamp: 'TODO-export' },
  ...
  { id: 'ring', group: 'Weapon', part: 'AR500 ring — 0.25 in, ~241 g', spec: 'Symmetric, no lightening or rim holes, taper to tune', role: 'The weapon is mass — steel carries 1.77× the energy of Ti at equal volume.', stamp: 'Estimate' },
  { id: 'teeth', group: 'Weapon', part: 'Standard teeth + 12.9 hardware', spec: '55.6 cm³ pair, 218 g ea in steel — 12.9 + Loctite 243', role: 'Symmetric 2-tooth. Balance on a point jig or it hops at 3000 RPM.', stamp: 'TODO-export' },
  { id: 'plates', group: 'Weapon', part: '6061-T6 plates + TPU cradle', spec: '6061 0.063–0.080 in + poly LED window + TPU 95A shell', role: 'Branch E formula: aluminum structure, TPU shock, never full-steel.', stamp: 'Estimate' },
