...
export const stackCards: StackCard[] = [
  ...
  { id: 'ring', group: 'Weapon', part: 'AR500 ring — 0.25 in, ~241 g', spec: 'Symmetric, no lightening or rim holes, taper to tune', role: 'The weapon is mass — steel carries 1.77× the energy of Ti at equal volume. Weigh yours.', stamp: 'Estimate' },
